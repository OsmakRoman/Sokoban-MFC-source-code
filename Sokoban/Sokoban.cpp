// Sokoban.cpp : Определяет поведение классов для приложения.
//
...
// создание CSokobanApp

CSokobanApp::CSokobanApp()
{
...
// Единственный объект CSokobanApp

CSokobanApp theApp;


// инициализация CSokobanApp
